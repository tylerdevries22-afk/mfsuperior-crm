...
const SPEC = {
  ...
  records: [
    ...
    { id: "tool-2", title: "Cargo securement kit", subtitle: "Straps, load bars, edge protectors, and seals", meta: "2 straps and seals low", status: "attention", tone: "warning", icon: "anchor", route: "/messages" },
