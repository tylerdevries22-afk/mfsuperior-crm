  ...
  return (
    <View style={[styles.fill, { backgroundColor: theme.background }]}>
      ...
      <Screen safeEdges={["left", "right", "bottom"]} scroll contentContainerStyle={styles.content}>
        ...
        <SimulationBanner message="History is generated by local prototype actions and seeded freight records." />
        <SegmentedControl
            ...
            <Card padding="none">
              {events.slice().reverse().map(({ event, shipment }, index) => (
                <ListRow
                  ...
                  key={event.id}
                  meta={`${event.eventCode} · ${shipment.targetLoadId}`}
                  onPress={() => router.push({ pathname: "/load/[id]", params: { id: shipment.id } })}
              ...
              {proofs.map((proof, index) => {
                ...
                return (
                  <ListRow
                    ...
                    key={proof.id}
                    meta={shipment?.targetLoadId ?? proof.shipmentId}
